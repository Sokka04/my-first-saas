                ...
                <div className="feature-section active" id="liste">
                    ...
                    <div className="hidden print:block box-border" style={{ fontFamily: "'Times New Roman', Times, serif", padding: '8mm' }}>
                        ...
                        <div className="w-full">
                                ...
                                <thead>
                                    ...
                                    {printType === 'students_list' && (
                                        <tr className="bg-gray-100">
                                            ...
                                            <th className="border border-black p-2 font-bold text-black min-w-[200px]" style={{ backgroundColor: '#f3f4f6', paddingLeft: '12px' }}>Nom & Prénom(s)</th>
                                    ...
                                    {printType === 'grades' && (
                                        <>
                                            <tr className="bg-gray-100">
                                                ...
                                                <th rowSpan={2} className="border border-black p-2 font-bold text-black min-w-[200px]" style={{ backgroundColor: '#f3f4f6', paddingLeft: '12px' }}>Nom & Prénoms</th>
                                    ...
                                    {printType === 'attendance' && (
                                        <tr className="bg-gray-100">
                                            ...
                                            <th className="border border-black p-2 font-bold text-black min-w-[200px]" style={{ backgroundColor: '#f3f4f6', paddingLeft: '12px' }}>Nom & Prénoms</th>
                            ...
                            {/* Signature / Fait à */}
                            <div className="flex justify-end w-full" style={{ paddingRight: '120px', pageBreakInside: 'avoid' }}>
