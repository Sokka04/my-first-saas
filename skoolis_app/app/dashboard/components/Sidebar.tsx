            ...
            <div className="logo-container">
                <div className="logo">
                    <div className="logo-top" style={{ justifyContent: 'center', marginBottom: '15px' }}>
                        <img src="/skoolis_logo_sombre.png" alt="Skoolis Logo" className="logo-light-theme" style={{ maxHeight: '28px', width: 'auto', objectFit: 'contain' }} />
                        <img src="/skoolis_logo_clair.png" alt="Skoolis Logo" className="logo-dark-theme" style={{ maxHeight: '28px', width: 'auto', objectFit: 'contain' }} />
                    </div>
